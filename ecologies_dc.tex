...
Even in the early history of computers, there were indicators of the value of applying computation to design. Ivan Sutherland's sketchpad is perhaps the best known early example of developing a computer interface expressly for visual design. Shifting to the present, digital software now impacts nearly all forms of contemporary design. In addition to graphic cad tools, the act of writing computer code is recognized a design skill. In the introduction to Design By Numbers, John Maeda argues that the true skill of a digital designer today is practiced art of computer programing \cite{maeda}. While Maeda describes a designer's dependence on computation in a particularly intense fashion, it is evident that computer programing, and design tools that enable it have a solid foundation in the professional design world. As designers ourselves, we are excited by the rich design accordances of professional computational design. Furthermore, we believe that computational design can be a powerful creative tool not just for professionals, but for amateurs, and in particular for young people with an interest in design. In this paper, we focus on visual computational design: the use of programing to generate form and pattern.%maybe a note on terminology here

At this point, amateur engagement in visual computational design is limited. This is in part due to practical and technical barriers. Many of the programming languages used for computational design were originally developed for general applications. As noted by Reas and Fry, most of the programing languages applied to design and the arts were not originally developed for this purpose, and technical skill required to apply languages like C++ and Java to visual design takes years to aquire \cite{reas}. This lengthy learning process is difficult to expect of a young person who is just getting started.  Although novice-oriented computer-aided-design (CAD) software is emerging, most of the available examples strongly emphasize graphic interaction, seldom featuring computational methods as an option for design.

Significant perceptual barriers also exist. Many people consider programming to be irrelevant to their interests, and are unmotivated to pursue what they perceive to be a highly specialized undertaking \cite{resnick1}. As Buechley and Hill point out, the lack of diverse participation in computational fields can partially be attributed to the perception that STEM applications themselves are constrained in cultural and intellectual diversity and breadth \cite{buechley_wild}. Efforts to engage novices in computer programing also frequently suffer from a lack of diverse applications.
We note that the majority of novice-oriented programming tools emphasize the production of screen-based media and the programing interactive behaviors citation?. While these skills are exciting to many, they are less relevant to people who are interested in aesthetic or physical forms of design.  Computational design however affords a rich set of creative opportunities which are directly applicable to a wide range of forms of making, aesthetic tastes, and creative pursuits.

Our goal is to open the creative opportunities to a diverse group of young people. We believe that two things are necessary for this to happen First, we must create computational design tools that emphasize the use of programing as a mechanism for visual design in a form that is feasible for first-time programmers to work with effectively. Two, we must find ways to apply these tools in contexts that are relevant and appealing to the present lives and interests of a broad range of young people.  

In pursuit of this goal, we have investigated the development of novice-oriented software tools within the field of computational design.  In a further effort to situate computational design in a relevant context, we developed activities which apply our tools to the design and creation of physical and functional crafts which connect to forms of making and artifacts which are both familiar and desirable to groups of young people who are traditionally underrepresented in computer science. 
